...
; Print the number of the player who wins.
...
; Print restart instructions
    LDX #0
.print_restart_str:
    LDA global_restart_str,X    ; Location of string.
    CMP #0                      ; Check null terminator
    BEQ .print_restart_str_end  ; If we're at the null terminator, exit.

    STA SCREEN_RAM+$179,X       ; Print that char to the screen
    LDA #$1                     ; Text Color
    STA SCREEN_COLOR_RAM+$179,X ; Set the color
    INX
    JMP .print_restart_str       ; Iterate!
.print_restart_str_end:
